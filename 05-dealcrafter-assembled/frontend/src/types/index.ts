/**
 * TypeScript type definitions for the Fiori AI Chat application.
 */
...
export interface ChatRequest {
  message: string;
  session_id?: string;
  timezone?: string;  // IANA timezone from browser, e.g. "America/New_York"
}
...
export type SSEEventType = 'text' | 'table' | 'error' | 'end';
...
export type SSEEvent = SSETextEvent | SSETableEvent | SSEErrorEvent | SSEEndEvent;
